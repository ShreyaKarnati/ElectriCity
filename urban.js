...
var budget = {
  ...
  totalEnergy: "25,000,000", 
  energyProduced: 0,
  emissionsTarget: "900,000,000",
  emissions: 0
};
...
function addSolar() {
  if(solar.current < solar.limit) {
    if(solar.current == 0) {
      ...
      var element = document.getElementById("solar4");
      element.classList.remove("hide");
      updateSolar(true);
    }
    else if (solar.current == 4) {
      var element = document.getElementById("solar5");
      element.classList.remove("hide");
      updateSolar(true);
    }
    else {
...
function addWind() {
  if(wind.current < wind.limit) {
    if(wind.current == 0) {
      ...
      var element = document.getElementById("wind3");
      element.classList.remove("hide");
      updateWind(true);
    }
    else if (wind.current == 3) {
      var element = document.getElementById("wind4");
      element.classList.remove("hide");
      updateWind(true);
    }
    else if (wind.current == 4) {
      var element = document.getElementById("wind5");
      element.classList.remove("hide");
      updateWind(true);
    }
    else {
...
function addNuclear() {
  if(nuclear.current < nuclear.limit) {
    ...
    else if (nuclear.current == 1) {
      var element = document.getElementById("nuclear2");
      element.classList.remove("hide");
      updateNuclear(true);
    }
    else {
...
function addCoal() {
  if(coal.current < coal.limit) {
    if(coal.current == 0) {
      ...
      var element = document.getElementById("coal4");
      element.classList.remove("hide");
      updateCoal(true);
    }
    else if (coal.current == 4) {
      var element = document.getElementById("coal5");
      element.classList.remove("hide");
      updateCoal(true);
    }
    else {
